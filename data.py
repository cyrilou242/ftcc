# extracted from https://github.com/bazingagin/npc_gzip
# LICENSE unknown
...
def load_kinnews_kirnews(
    ...
    # FIXME WARNING - data in huggingface is bad - https://github.com/bazingagin/npc_gzip/issues/13
...
def load_filipino():
    ...
    # FIXME hugging face dataset is incorrect
